  ...
  return (
    ...
    <div className="h-screen flex justify-center items-center  flex-col text-center">
      <h1 className="text-4xl md:text-5xl font-bold mb-10">
            Cara Kerja <span className="text-emerald-400">EduCoin</span>
          </h1>

          <p className="text-lg text-gray-950 max-w-2xl mb-16">
            EduCoin adalah sistem beasiswa transparan berbasis blockchain. Setiap transaksi tercatat secara publik dan hanya dapat digunakan untuk keperluan edukatif.
          </p>

        <BlurFade inView>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl w-full">
            <MagicCard>
              <h1 className="text-xl font-semibold text-emerald-600 mb-2">1. Pemberi Beasiswa</h1>
              <p className="text-gray-950 text-sm">
                Donatur mengirimkan dana dalam bentuk <span className="text-emerald-400 font-medium">EduCoin</span> ke dompet penerima.
              </p>
            </MagicCard>

            <MagicCard>
              <h1 className="text-xl font-semibold text-emerald-600 mb-2">2. Dompet Penerima</h1>
              <p className="text-gray-950 text-sm">
                Penerima menggunakan wallet non-custodial untuk menyimpan dan membelanjakan EduCoin.
              </p>
            </MagicCard>

            <MagicCard>
              <h1 className="text-xl font-semibold text-emerald-600 mb-2">3. Pembatasan Penggunaan</h1>
              <p className="text-gray-950 text-sm">
                EduCoin tidak dapat di-swap atau diuangkan. Hanya bisa digunakan ke merchant edukasi yang <span className="text-emerald-400">terverifikasi</span>.
              </p>
            </MagicCard>

            <MagicCard>
              <h1 className="text-xl font-semibold text-emerald-600 mb-2">4. Transaksi On-Chain</h1>
              <p className="text-gray-950 text-sm">
                Seluruh aktivitas penerima tercatat secara <span className="text-emerald-400">on-chain</span> dan bisa diaudit publik.
              </p>
            </MagicCard>

            <MagicCard>
              <h1 className="text-xl font-semibold text-emerald-600 mb-2">5. Audit Otomatis</h1>
              <p className="text-gray-950 text-sm">
                Sistem melakukan pengecekan otomatis terhadap penyalahgunaan atau transaksi ilegal.
              </p>
            </MagicCard>

            <MagicCard>
              <h1 className="text-xl font-semibold text-emerald-600 mb-2">6. Transparansi Penuh</h1>
              <p className="text-gray-950 text-sm">
                Donatur dapat memantau penggunaan dana secara real-time melalui dashboard transparan.
              </p>
            </MagicCard>
          </div>
        </BlurFade>
